...
class PathPublisher(Node):
    def __init__(self):
        ...
        self.cone_distance_threshold = 4.0 # 중점이 생길 수 있는 콘 사이의 최대거리
        # Subscribers
        ...
        self.timer = self.create_timer(0.3, self.path_create)
    ...
    def spline_interpolation(self, points, s=1, k=3, spacing=0.1):
        ...
        # # 일정한 간격(0.1)으로 보간할 점들의 누적 거리 설정
        # num_points = int(total_distance / spacing)  # 0.1 간격으로 배치할 점의 개수
        ...
        interpolated_x, interpolated_y, cyaw, ck, s = calc_spline_course(x,y,ds=0.1)
