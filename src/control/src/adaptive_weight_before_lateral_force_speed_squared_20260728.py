...
class AdaptiveWeightNode:
    ...
    def updateWeight(self):
        ...
        # Smooth speed scheduling. 35 km/h is the point where lateral vehicle
        # response starts becoming sensitive, but tanh keeps this continuous;
        # there is no high/low-speed mode switch.
        speed_reference = max(
